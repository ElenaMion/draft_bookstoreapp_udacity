...
public class SupplierEditor extends AppCompatActivity implements
    ...
    private void saveSupplier() {
        ...
        int supplierExists = supplierExistsInDB(supplierNameStr);
     ...
     */
    private int supplierExistsInDB(String supplierName) {
        String[] projection = {
                SupplierEntry._ID,
        ...
        Cursor cursor = getContentResolver().query(SupplierEntry.CONTENT_URI,
...
//        String selection = DeliveryEntry.COLUMN_SUPPLIER_ID + "= ? AND " +
//                DeliveryEntry.COLUMN_SUPPLIER_ID + "=" + SupplierEntry.TABLE_NAME + "." + SupplierEntry._ID;
//        String[] selectionArgs = new String[]{supplierId};
